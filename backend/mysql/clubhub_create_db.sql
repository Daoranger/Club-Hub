...
CREATE INDEX name_IDX on Club (name);
...
CREATE INDEX CID_IDX on Event (CID);
...
CREATE INDEX CID_IDX on Post (CID);
...
CREATE INDEX CID_IDX on ChatRoom (CID);
...
CREATE INDEX CRID_IDX on Message (CRID);
...
CREATE INDEX CID_IDX on Thread (CID);
...
CREATE INDEX TID_IDX on ThreadReply (TID);
...
CREATE INDEX CID_IDX on Role (CID);
